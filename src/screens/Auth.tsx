        ...
        >
          ...
          <div className="flex flex-col items-center gap-2 mb-8">
              <div className="w-24 h-24 rounded-full bg-white flex items-center justify-center shadow-md border-2 border-slate-50 overflow-hidden">
                  <img src="/input_file_0.png" alt="Nexvy Logo" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
              </div>
            ...
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  // Clear any existing stale sessions before initiating OAuth
                  try {
                  ...
                  // Use window.location.origin to ensure it works in both dev and production
                  const origin = window.location.origin;
                  
                  console.log('[AUTH] Initiating Google OAuth with origin:', origin);
                  ...
                  console.error('[AUTH] Google OAuth initialization failed:', e);
                  setError('Google auth failed to initialize. Please try again.');
                  setAuthLoading(false);
                }
              }}
              disabled={authLoading}
              className="w-full py-4 bg-white hover:bg-slate-50 text-slate-700 font-bold flex items-center justify-center gap-3 rounded-2xl border-2 border-slate-100 transition-all shadow-sm hover:shadow-md active:scale-[0.98] disabled:opacity-50 group"
            >
              ...
              <span className="uppercase text-[11px] font-black tracking-widest">Continue with Google</span>
            </button>
          </form>
