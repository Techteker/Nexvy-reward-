...
export const SettingsPanel: React.FC = () => {
  ...
  const [appwriteConfig, setAppwriteConfig] = useState({
    endpoint: localStorage.getItem('VITE_APPWRITE_ENDPOINT') || 'https://fra.cloud.appwrite.io/v1',
    projectId: localStorage.getItem('VITE_APPWRITE_PROJECT_ID') || '6a016eac001c0af48909',
    databaseId: localStorage.getItem('VITE_APPWRITE_DATABASE_ID') || '67d163d8000b08051772',
    bucketId: localStorage.getItem('VITE_APPWRITE_STORAGE_BUCKET_ID') || '67d16b1c000c19b02a9e'
  });
